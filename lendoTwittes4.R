...
myStopwords <- c(stopwords("portuguese"), "ia", "faria", "ainda", "caminho", "alcool")
# remove 'r' and 'big' from stopwords
myStopwords <- setdiff(myStopwords, c("h", "c"))
...
idx <- which(dimnames(tdm)$Terms == "c")
inspect(tdm[idx + (0:5), 101:110])
###########################################################################
